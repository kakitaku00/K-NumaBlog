  ...
  <div class="modal-container bg-white w-11/12 md:max-w-xl mx-auto rounded shadow-lg z-50 overflow-y-auto">
    <div class="modal-content py-4 text-left px-6">
      <div class="flex justify-between items-center mb-6">
        ...
        <div on:click class="modal-close cursor-pointer z-50">
      ...
      <div class="mb-6">
        ...
        <span class="block text-gray-700">{text}</span>
      </div>

      <div class="flex justify-center pt-2">
        <button on:click class="bg-white text-blue-700 font-semibold mr-2 py-2 px-4 border border-blue-500 hover:opacity-75 rounded">キャンセル</button>
        <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">内容を送信</button>
      </div>
    </div>
  </div>
</div>